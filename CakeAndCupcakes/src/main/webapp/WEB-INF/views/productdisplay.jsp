    ...
    <div class="row">
        <div class="col-md-12">
			<div class="col-xs-12 col-sm-3 col-md-12">
				...
				<img  src="{{group.img}}" />
				<div> <h3><span class="h4 text-uppercase">{{group.name}}</span></h3>
				<p><span class="h4 ">Price: Rs {{group.price}}</span>	</p>
					<!-- <div class="caption"> -->
					<div class="info">
						<div class="row">
							...
							<div class="col-md-12 col-sm-3 col-xs-12">
								<!-- <a href="#" class="btn btn-success btn-product"><span class="glyphicon glyphicon-shopping-cart"></span> Add 2 Cart</a> -->
    						     <a href="<c:url value='/productview{{group.id}}' />"><span class="fa fa-list"></span>More Details</a>
    						     <a href="cartItem/add?id={{group.id}}" class="btn btn-success btn-product" ><span class="glyphicon glyphicon-shopping-cart"></span>Add 2 Cart</a></td>
    						</div>
						</div>
